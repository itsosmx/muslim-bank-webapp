...
export default function Privacy() {
  return (
    <div className="container">
      ...
      <p>
        OSMX built the <span> Muslim Bank</span> app as a Free app. This SERVICE is provided by OSMX at no cost and is intended for
        use as is.
      </p>
      <p>
      ...
      <p>
        ...
        accessible at Muslim Bank unless otherwise defined in this Privacy Policy.
      </p>
      <p>
      ...
      <p>This policy is effective as of 2023-02-01</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at
        <a href="mailto:itsosmx@gmail.com">itsosmx@gmail.com</a>.
      </p>
    </div>
  );
}
